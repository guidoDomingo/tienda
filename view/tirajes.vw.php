	...
	<div class="panel panel-flat">
		...
		<div class="panel-heading">
			...
			<div class="heading-elements">
				<button type="button" class="btn btn-primary heading-btn" onclick="newTiraje()">
									...
									<ul class="icons-list">
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												<li><a href="javascript:;" data-toggle="modal" data-target="#modal_iconified" onclick="openTiraje('editar',
					...
					<div class="modal-body" id="modal-container">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-6">
									...
									<select data-placeholder="..." id="cbCompro" name="cbCompro" class="select-search" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
										<?php
								...
								<div class="col-sm-5">
									...
									<div class="input-group">
										...
										<input type="text" id="txtFechaT" name="txtFechaT" placeholder="" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-5">
									...
									<input type="text" id="txtNoResolucion" name="txtNoResolucion" placeholder="30202-RES-CR-38701-2015" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-6">
									<label>Del</label>
									<input type="text" id="txtDel" name="txtDel" placeholder="1" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>

								<div class="col-sm-6">
									<label>Al</label>
									<input type="text" id="txtAl" name="txtAl" placeholder="200000" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-6">
									...
									<input type="text" id="txtDispo" name="txtDispo" placeholder="" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled">
								</div>

								<div class="col-sm-6">
									<label>Utilizados</label>
									<input type="text" id="txtUsados" name="txtUsados" placeholder="" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" disabled="disabled">
								</div>
