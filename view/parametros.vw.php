	...
	<div class="panel panel-flat">
		...
		<div class="panel-heading">
			...
			<div class="heading-elements">
				<button type="button" class="btn btn-primary heading-btn" onclick="newParametro()">
									...
									<ul class="icons-list">
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												<li><a  data-toggle="modal" data-target="#modal_iconified" onclick="openParametro('editar',
												...
												<li><a  data-toggle="modal" data-target="#modal_iconified" onclick="openParametro('ver',
								                     '<?php print($column['idparametro']); ?>',
								                     '<?php print($column['nombre_empresa']); ?>',
								                     '<?php print($column['propietario']); ?>',
								                     '<?php print($nit); ?>',
				...
				<form role="form" autocomplete="off" class="form-validate-jquery" id="frmModal">
					<div class="modal-body" id="modal-container">
						...
						<div class="alert alert-info alert-styled-left text-blue-800 content-group">
							...
							<input type="hidden" id="txtProceso" name="txtProceso" class="form-control" value="Edicion">
						</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									...
									<select data-placeholder="..." id="cbMoneda" name="cbMoneda" class="select-search" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
										<?php
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									...
									<input type="text" id="txtEmpresa" name="txtEmpresa" placeholder="EJ. MINI MARKET" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-12">
									...
									<input type="text" id="txtPropietario" name="txtPropietario" placeholder="EJ. ABEL ALVARADO" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-6">
									...
									<input type="text" id="txtPIVA" name="txtPIVA" placeholder="EJ. 18.00" class="touchspin-prefix" value="0" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>


								<div class="col-sm-6">
									<label>Porcentaje Retencion <span class="text-danger">*</span></label>
									<input type="text" id="txtPRET" name="txtPRET" placeholder="EJ. 1.00" class="touchspin-prefix" value="0" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-6">
									...
									<input type="text" id="txtMontoR" name="txtMontoR" placeholder="EJ. 1.00" class="touchspin-prefix" value="0" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>

								<div class="col-sm-6">
									<label>Direccion <span class="text-danger">*</span></label>
									<textarea rows="3" class="form-control" placeholder="EJ. CALLE MALECON IQUIQUE 406 MIRAFLORES, AREQUIPA - PERU" id="txtDireccion" name="txtDireccion" value="" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
													</textarea>
								</div>
							</div>
						</div>
